...
both inorganic solutes and DOM with metal competition, and with a fixed ZLP.
"""
...
def alkalinity_from_dic_pH(dic, pH, totals, k_constants, nd_params):
    ...
    sw = speciate.inorganic_dom_metals(dic, pH, totals, k_constants, nd_params)
...
def _pH_from_alkalinity_dic(alkalinity, dic, totals, k_constants, nd_params):
    ...
    def cond(pH__log10_chi):
        residuals = residual.pH_from_alkalinity_dic_dom_metals(
    ...
    def body(pH__log10_chi):
        ...
        residuals_jac = residual.pH_from_alkalinity_dic_dom_metals_jac(
            pH__log10_chi, alkalinity, dic, totals, k_constants, nd_params
        )
