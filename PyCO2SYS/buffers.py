...
def d_lnCO2__d_pH__dic(dic, pH, pk_CO2, pk_H2CO3, pk_HCO3):
    dic, pH = np.broadcast_arrays(dic, pH, pk_CO2, pk_H2CO3, pk_HCO3)[:2]
    return egrad(
        lambda pH: np.log(
            pk_CO2
...
def d_CO3__d_pH__dic(dic, pH, pk_H2CO3, pk_HCO3):
    dic, pH = np.broadcast_arrays(dic, pH, pk_H2CO3, pk_HCO3)[:2]
    return egrad(
        lambda pH: solve.inorganic.CO3_from_dic_pH(dic, pH, pk_H2CO3, pk_HCO3)
    )(pH)
...
def Q_isocap_approx(dic, pCO2, pk_CO2, pk_H2CO3, pk_HCO3):
