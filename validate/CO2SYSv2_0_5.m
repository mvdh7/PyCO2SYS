function [DATA,HEADERS,NICEHEADERS]=CO2SYSv2_0_5(PAR1,PAR2,PAR1TYPE,PAR2TYPE,SAL,TEMPIN,TEMPOUT,PRESIN,PRESOUT,SI,PO4,pHSCALEIN,K1K2CONSTANTS,KSO4CONSTANTS);
%
% COPIED DIRECTLY FROM
% https://github.com/jamesorr/CO2SYS-MATLAB/blob/master/src/CO2SYS.m
% ON 19 MARCH 2020
% DON'T USE THIS, GET IT FROM THERE YOURSELF!
%
%**************************************************************************
%
