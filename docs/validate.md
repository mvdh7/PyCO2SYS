...
!!! info "PyCO2SYS v1.4.0"
    All the comparisons, numbers and figures shown on this page were carried out with PyCO2SYS v1.4.0, but they have not been altered by the update to v1.4.1.
